...
function LandingPage() {
  return (
    <>
      <div className="h-screen bg-red-200 w-full hero-bg flex items-center justify-center text-white">
        ...
        <div className="h-32 w-14 bg-white fixed end-0 flex flex-col rounded-l-md items-center justify-evenly">
